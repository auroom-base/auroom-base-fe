...
const benefits = [
    {
        ...
        image: 'https://images.unsplash.com/photo-1657408056887-c8c627f7574a?w=800&q=60&auto=format&fit=crop',
    },
    {
        iconType: 'percent' as const,
        title: 'Zero Hidden Fees',
        description: 'Transparent 0.5% flat fee. No compound interest, no administration charges.',
        image: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=800&q=60&auto=format&fit=crop',
    },
    {
        iconType: 'shield' as const,
        title: 'Bank-Grade Security',
        description: 'Your physical gold is insured and stored in regulated vaults. Smart contracts are audited.',
        image: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=800&q=60&auto=format&fit=crop',
    },
    {
        iconType: 'globe' as const,
        title: '24/7 Access',
        description: 'Your assets never sleep. Borrow or repay anytime, from anywhere in the world.',
        image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=60&auto=format&fit=crop',
    },
    {
        iconType: 'smartphone' as const,
        title: 'Fully Digital',
        description: 'No paperwork, no office visits. Manage your loans entirely from your dashboard.',
        image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=800&q=60&auto=format&fit=crop',
    },
    {
        ...
        image: 'https://images.unsplash.com/photo-1638202947561-e372255007b3?w=800&q=60&auto=format&fit=crop',
    },
];
